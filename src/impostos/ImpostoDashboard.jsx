...
class ImpostoDashBoard extends Component {
  state = {
    loadingProd: false,
    dataProd: []
  };
  ...
  render() {
    ...
    return (
      <Card className={this.props.classes.root}>
        <Title title="Painel Imposto" />
        <CardContent>
          <Search handlePesquisar={this.fetchImpostos.bind(this)} />
...
ImpostoDashBoard.propTypes = {
  classes: PropTypes.object.isRequired
};

export default compose(withStyles(styles))(ImpostoDashBoard);
